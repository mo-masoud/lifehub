...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    return (
        <AuthLayout title={__('auth.login_to_your_account')} description={__('auth.login_description')}>
            ...
            <form className="flex flex-col gap-6" onSubmit={submit}>
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink href={route('dashboard.password.request')} className="ml-auto text-sm" tabIndex={5}>
                ...
                {/*    <TextLink href={route('dashboard.register')} tabIndex={5}>*/}
                {/*        Sign up*/}
                {/*    </TextLink>*/}
                {/*</div>*/}
            </form>
