...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'exchange_rates.api_url' => 'string',
            'exchange_rates.max_manual_calls_per_day' => 'integer',
            'exchange_rates.default_cache_hours' => 'integer',
            'exchange_rates.fetch_frequencies.daily.label' => 'string',
            'exchange_rates.fetch_frequencies.daily.hours' => 'integer',
            'exchange_rates.fetch_frequencies.weekly.label' => 'string',
            'exchange_rates.fetch_frequencies.weekly.hours' => 'integer',
            'exchange_rates.fetch_frequencies.monthly.label' => 'string',
            'exchange_rates.fetch_frequencies.monthly.hours' => 'integer',
            ...
            'filesystems.links./home/masoud/own/lifehub/public/storage' => 'string',
            ...
            'x-dash.prefix' => 'string',
            'x-dash.available_languages.en.name' => 'string',
            'x-dash.available_languages.en.dir' => 'string',
            'x-dash.available_languages.en.key' => 'string',
            'x-dash.available_languages.ar.name' => 'string',
            'x-dash.available_languages.ar.dir' => 'string',
            'x-dash.available_languages.ar.key' => 'string',
            'cors.paths' => 'array',
...
'database.redis.cache.port','database.redis.cache.database','exchange_rates.api_url','exchange_rates.max_manual_calls_per_day','exchange_rates.default_cache_hours',
'exchange_rates.fetch_frequencies.daily.label','exchange_rates.fetch_frequencies.daily.hours','exchange_rates.fetch_frequencies.weekly.label','exchange_rates.fetch_frequencies.weekly.hours','exchange_rates.fetch_frequencies.monthly.label',
'exchange_rates.fetch_frequencies.monthly.hours','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/masoud/own/lifehub/public/storage','inertia.ssr.enabled',
...
'session.http_only','session.same_site','session.partitioned','x-dash.prefix','x-dash.available_languages.en.name',
'x-dash.available_languages.en.dir','x-dash.available_languages.en.key','x-dash.available_languages.ar.name','x-dash.available_languages.ar.dir','x-dash.available_languages.ar.key',
...
'signed','throttle','verified','dashboard.auth',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','api.','api.dashboard.savings.transaction-categories.index','api.dashboard.savings.transaction-categories.store','api.dashboard.savings.storage-locations.index',
'api.dashboard.savings.storage-locations.store','home','locale','dashboard.register',
'dashboard.','dashboard.login','dashboard.','dashboard.password.request','dashboard.password.email',
'dashboard.password.reset','dashboard.password.store','dashboard.verification.notice','dashboard.verification.verify','dashboard.verification.send',
'dashboard.password.confirm','dashboard.','dashboard.logout','dashboard.home','dashboard.',
'dashboard.profile.edit','dashboard.profile.update','dashboard.profile.destroy','dashboard.password.edit','dashboard.password.update',
'dashboard.appearance','dashboard.settings.locale','dashboard.settings.savings.rate-fallback.update','dashboard.passwords.index','dashboard.passwords.store',
'dashboard.passwords.update','dashboard.passwords.destroy','dashboard.sshs.index','dashboard.sshs.store','dashboard.sshs.update',
'dashboard.sshs.destroy','dashboard.folders.index','dashboard.folders.store','dashboard.folders.show','dashboard.savings.initial.store',
'dashboard.savings.initial.update','dashboard.savings.initial.destroy','dashboard.savings.initial.complete','dashboard.savings.snapshots.index','dashboard.savings.snapshots.store',
'dashboard.savings.snapshots.destroy','dashboard.savings.transactions.index','dashboard.savings.transactions.store','dashboard.savings.transactions.update','dashboard.savings.transactions.destroy',
'dashboard.savings.storage-locations.index','dashboard.savings.storage-locations.store','dashboard.savings.storage-locations.update','dashboard.savings.storage-locations.destroy','dashboard.savings.transaction-categories.index',
'dashboard.savings.transaction-categories.store','dashboard.savings.transaction-categories.update','dashboard.savings.transaction-categories.destroy','dashboard.savings.goals.index','dashboard.savings.goals.store',
'dashboard.savings.goals.update','dashboard.savings.goals.destroy','dashboard.savings.goals.mark-achieved','dashboard.savings.goals.dismiss-notification','dashboard.api.savings.goals.index',
'storage.local',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','dashboard.general.application_name','dashboard.general.dashboard','dashboard.general.platform',
'dashboard.general.home','dashboard.general.settings','dashboard.general.password_manager','dashboard.general.passwords','dashboard.general.search',
'dashboard.general.ssh_manager','dashboard.general.savings','dashboard.stats.current_savings','dashboard.stats.as_of','dashboard.stats.no_snapshots',
'dashboard.stats.create_first_snapshot','dashboard.stats.top_transaction_week','dashboard.stats.top_transaction_month','dashboard.stats.top_transaction_quarter','dashboard.stats.top_transaction_year',
'dashboard.stats.top_transaction','dashboard.stats.period_week','dashboard.stats.period_month','dashboard.stats.period_quarter','dashboard.stats.period_year',
'dashboard.stats.period_overall','dashboard.stats.no_transactions','dashboard.stats.amount','dashboard.stats.category','dashboard.stats.date',
'dashboard.stats.total_expenses','dashboard.stats.total_income','dashboard.stats.expense_percentages','dashboard.stats.no_expenses','dashboard.stats.no_income',
'dashboard.stats.view_details','dashboard.stats.other_categories','dashboard.stats.top_categories_expenses','dashboard.stats.expense_breakdown','dashboard.stats.expense_distribution',
'dashboard.stats.all_categories','dashboard.stats.coming_soon','dashboard.messages.save','dashboard.messages.saved','dashboard.messages.warning',
'dashboard.messages.cancel','dashboard.messages.caution_cant_undone','dashboard.messages.or_return','dashboard.messages.new','dashboard.messages.next',
'dashboard.messages.previous','dashboard.messages.delete','dashboard.messages.delete_confirmation','dashboard.messages.update','dashboard.messages.history',
'dashboard.messages.showing_pagination','dashboard.messages.deleted_successfully','dashboard.messages.created_successfully','dashboard.messages.something_went_wrong','dashboard.messages.updated_successfully',
'dashboard.messages.filter','dashboard.messages.choose_from_list_or_create_new','dashboard.auth.login','dashboard.auth.login_to_your_account','dashboard.auth.login_description',
'dashboard.auth.remember_me','dashboard.auth.confirm_password','dashboard.auth.confirm_password_description','dashboard.auth.forgot_password','dashboard.auth.forgot_password_question',
'dashboard.auth.forgot_password_description','dashboard.auth.send_password_reset_link','dashboard.auth.reset_password','dashboard.auth.reset_password_description','dashboard.auth.verify_email',
'dashboard.auth.verify_email_description','dashboard.auth.verify_email_verification','dashboard.auth.verification_link_sent','dashboard.auth.resend_verify_email','dashboard.settings.setting_description',
'dashboard.settings.profile','dashboard.settings.profile_settings','dashboard.settings.profile_info','dashboard.settings.profile_info_description','dashboard.settings.appearance',
'dashboard.settings.appearance_settings','dashboard.settings.appearance_settings_description','dashboard.settings.light','dashboard.settings.dark','dashboard.settings.system',
'dashboard.settings.password','dashboard.settings.update_password','dashboard.settings.update_password_description','dashboard.settings.save_password','dashboard.settings.locale_settings',
'dashboard.settings.locale_settings_description','dashboard.settings.price_rate_fallback','dashboard.settings.price_rate_fallback_description','dashboard.home_page.savings_module_title','dashboard.home_page.savings_module_description',
'dashboard.home_page.savings_overview_title','dashboard.home_page.savings_setup_title','dashboard.home_page.savings_setup_description','dashboard.home_page.savings_settings_title','dashboard.home_page.savings_settings_description',
'dashboard.profile.logout','dashboard.profile.delete_account','dashboard.profile.delete_account_description','dashboard.profile.delete_account_confirmation','dashboard.profile.delete_account_confirmation_text',
'dashboard.profile.email_unverified','dashboard.profile.resend_verification_link','dashboard.fields.name','dashboard.fields.username','dashboard.fields.full_name',
'dashboard.fields.email','dashboard.fields.password','dashboard.fields.confirm_password','dashboard.fields.current_password','dashboard.fields.new_password',
'dashboard.fields.preferred_locale','dashboard.fields.url','dashboard.fields.name_placeholder','dashboard.passwords.create_password','dashboard.passwords.name_placeholder',
'dashboard.passwords.username_placeholder','dashboard.passwords.url_placeholder','dashboard.passwords.password_placeholder','dashboard.passwords.no_passwords_founds','dashboard.words.actions',
'dashboard.savings.save_initial_savings','dashboard.savings.save_initial_savings_warning','dashboard.savings.initial_savings_completed','dashboard.savings.home','dashboard.savings.bank',
'dashboard.savings.initial_balance','dashboard.savings.no_balances_founds','dashboard.savings.type','dashboard.savings.amount','dashboard.savings.storage',
'dashboard.savings.create_balance','dashboard.savings.type_placeholder','dashboard.savings.amount_placeholder','dashboard.savings.storage_placeholder','dashboard.savings.USD',
'dashboard.savings.EGP','dashboard.savings.GOLD24','dashboard.savings.GOLD21','dashboard.savings.create_new_storage','dashboard.savings.storage_name_placeholder',
'dashboard.savings.snapshots','dashboard.savings.no_snapshots_founds','dashboard.savings.usd_rate','dashboard.savings.gold24_price','dashboard.savings.gold21_price',
'dashboard.savings.date','dashboard.savings.rate','dashboard.savings.total_usd','dashboard.savings.total_egp','dashboard.savings.changes',
'dashboard.savings.snapshot_details','dashboard.savings.transactions','dashboard.savings.no_transactions_founds','dashboard.savings.direction','dashboard.savings.direction_placeholder',
'dashboard.savings.from_type','dashboard.savings.from_amount','dashboard.savings.from_location','dashboard.savings.to_location','dashboard.savings.from_location_placeholder',
'dashboard.savings.to_location_placeholder','dashboard.savings.notes','dashboard.savings.create_transaction','dashboard.savings.in','dashboard.savings.out',
'dashboard.savings.transfer','dashboard.savings.from_type_placeholder','dashboard.savings.from_amount_placeholder','dashboard.savings.min_date','dashboard.savings.max_date',
'dashboard.savings.min_amount','dashboard.savings.max_amount','dashboard.savings.min_amount_placeholder','dashboard.savings.max_amount_placeholder','dashboard.savings.usd_rate_fallback',
'dashboard.savings.gold24_rate_fallback','dashboard.savings.gold21_rate_fallback','dashboard.savings.usd_rate_fallback_placeholder','dashboard.savings.gold24_rate_fallback_placeholder','dashboard.savings.gold21_rate_fallback_placeholder',
'dashboard.savings.notes_placeholder','dashboard.savings.update_balance','dashboard.savings.update_transaction','dashboard.savings.category','dashboard.savings.category_placeholder',
'dashboard.savings.category_name_placeholder','dashboard.savings.category_direction_placeholder','dashboard.savings.storage_locations','dashboard.savings.create_storage_location','dashboard.savings.no_storage_locations_founds',
'dashboard.savings.usd','dashboard.savings.egp','dashboard.savings.gold24','dashboard.savings.gold21','dashboard.savings.transaction_categories',
'dashboard.savings.no_transaction_categories_found','dashboard.savings.create_transaction_category','dashboard.savings.update_transaction_category','dashboard.savings.total','dashboard.savings.total_year',
'dashboard.savings.total_month','dashboard.savings.total_week','dashboard.savings.goals','dashboard.ssh.create_ssh','dashboard.ssh.update_ssh',
'dashboard.ssh.name_placeholder','dashboard.ssh.username_placeholder','dashboard.ssh.password_placeholder','dashboard.ssh.ip_placeholder','dashboard.ssh.prompt',
'dashboard.ssh.prompt_placeholder','dashboard.ssh.no_sshs_founds','dashboard.auth_layout.title_placeholder','dashboard.auth_layout.description_placeholder','dashboard.home',
'dashboard.bank','dashboard.grocery','dashboard.restaurant','dashboard.entertainment','dashboard.fuel',
'dashboard.car maintenance','dashboard.rent','dashboard.subscriptions','dashboard.internet','dashboard.mobile bill',
'dashboard.electricity','dashboard.water','dashboard.pharmacy','dashboard.clothes','dashboard.donation',
'dashboard.gifts','dashboard.education','dashboard.tools & electronics','dashboard.transportation','dashboard.kids expenses',
'dashboard.pets','dashboard.home maintenance','dashboard.vacation','dashboard.salary','shared.January',
'shared.February','shared.March','shared.April','shared.May','shared.June',
'shared.July','shared.August','shared.September','shared.October','shared.November',
'shared.December','dashboard.fields.ip','dashboard.passwords.update_password','dashboard.ssh.ip','dashboard.words.top',
'dashboard.words.this_month',);
